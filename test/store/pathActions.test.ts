    ...
    loadGlyph([
      {
        ...
        closed: true,
        nodes: [
          { id: 'n1', x: 0, y: 0, type: 'corner' },
          { id: 'h1', x: 25, y: 100, type: 'offcurve' },
          { id: 'h2', x: 75, y: 100, type: 'offcurve' },
          { id: 'n2', x: 100, y: 0, type: 'corner' },
          { id: 'h3', x: 100, y: -50, type: 'offcurve' },
          { id: 'h4', x: 0, y: -50, type: 'offcurve' },
        ],
      },
    ])
    ...
    loadGlyph([
      {
        ...
        nodes: [
          ...
          { id: 'h3', x: 100, y: -50, type: 'offcurve' },
          { id: 'h4', x: 0, y: -50, type: 'offcurve' },
          { id: 'n3', x: -50, y: 0, type: 'corner' },
          { id: 'h5', x: -75, y: 50, type: 'offcurve' },
          { id: 'h6', x: -25, y: 50, type: 'offcurve' },
        ],
      },
    ])
