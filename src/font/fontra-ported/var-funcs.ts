...
// source: src-js/fontra-core/src/var-funcs.js
// Item-wise add/sub and scalar multiply over numbers, arrays and objects,
// recursively. Used by the variation model. Keep in sync — see
// docs/fontra-parity.md

import { VariationError } from './errors'

export function addItemwise(a: any, b: any): any {
...
export function subItemwise(a: any, b: any): any {
  if (typeof a !== typeof b) {
    throw new VariationError(
      `incompatible object types: typeof ${a} != typeof ${b}`
    )
...
export function mulScalar(o: any, scalar: number): any {
...
function itemwiseFunc(a: any, b: any, func: (a: any, b: any) => any) {
  let result
  if (Array.isArray(a)) {
    result = new (a.constructor as any)(a.length)
    ...
    result = new (a.constructor as any)()
...
function objectMap(
  o: any,
  argument: number,
  func: (o: any, argument: number) => any
) {
  let result
  if (Array.isArray(o)) {
    return o.map((item) => func(item, argument))
  } else {
    result = new (o.constructor as any)()
